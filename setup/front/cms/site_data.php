...
return array(
    ...
    'monitoring' => array( // Мониторинг изменений в системе
        'scanDir' => "", // Путь до папки (с ведущим слешем), в которой нужно проводить сканирование. Если пусто, то сканируется весь сайт. | Ideal_Text
        'excludedScanDir' => "", // Пути до папок или файлов (с ведущим слешем), которые нужно исключить из сканирования (каждый с новой строки) | Ideal_Area
        'mailNotification' => "top@neox.ru", // Почта для отправки уведомлений об изменениях | Ideal_Text
        'tmpDir' => "/tmp", // Путь к папке (с ведущим слешем) с временными файлами  | Ideal_Text
    ),
);
